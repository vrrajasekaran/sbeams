...
###############################################################################
use strict;
use vars qw ($q $sbeams $sbeamsProteinStructure $PROGRAM_FILE_NAME
...
$sbeamsProteinStructure = new SBEAMS::ProteinStructure;
$sbeamsProteinStructure->setSBEAMS($sbeams);
...
sub main { 
    ...
    $sbeamsProteinStructure->printPageHeader();
    showMainPage();
    $sbeamsProteinStructure->printPageFooter();
...
sub showMainPage {
	...
	<UL>
	<LI> Here is the starter stub for the ProteinStructure area.
	</UL>
