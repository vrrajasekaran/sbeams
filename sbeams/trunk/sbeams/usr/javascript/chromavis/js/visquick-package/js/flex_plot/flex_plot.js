...
vq.FlexPlot = function() {
    ...
    vq.FlexPlot.prototype = pv.extend(vq.Vis);

vq.FlexPlot.prototype._setOptionDefaults =  function(options) {
    ...
    vq.FlexPlot.prototype.setXRange = function(x,dx){
        this.posX.domain(x, x+dx);
        this.redraw();
};

    vq.FlexPlot.prototype.draw = function(data) {

        this._bl_data = new vq.models.FlexPlotData(data);
    ...
    vq.FlexPlot.prototype.render = function() {
        var that = this;
...
vq.models.FlexPlotData = function(data) {
    vq.models.VisData.call(this,data);

    this.setDataModel();

            if (this.getDataType() == 'vq.models.FlexPlotData') {
                this._build_data(this.getContents());
            } else {
                console.warn('Unrecognized JSON object.  Expected vq.models.FlexPlotData object.');
            }
        };
vq.models.FlexPlotData.prototype = pv.extend(vq.models.VisData);

vq.models.FlexPlotData.prototype._build_data = function(data) {
...
vq.models.FlexPlotData.prototype.setDataModel = function () {
    this._dataModel = [
