package SBEAMS::GEAP::HTMLPrinter;

###############################################################################
# Program     : SBEAMS::GEAP::HTMLPrinter
...
sub printPageHeader {
	...
	<tr><td><a href="$CGI_BASE_DIR/GEAP/ManageTable.cgi?TABLE_NAME=source_db"><nobr>&nbsp;&nbsp;&nbsp;Source DB</nobr></a></td></tr>
	</table>
	</td>
