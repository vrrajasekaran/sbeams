package SBEAMS::TOES::HTMLPrinter;

###############################################################################
# Program     : SBEAMS::TOES::HTMLPrinter
...
sub printPageHeader {
	...
	<tr><td><a href="$CGI_BASE_DIR/TOES/ManageTable.cgi?TABLE_NAME=source_db"><nobr>&nbsp;&nbsp;&nbsp;Source DB</nobr></a></td></tr>
	</table>
	</td>
