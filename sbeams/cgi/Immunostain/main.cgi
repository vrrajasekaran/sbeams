...
###############################################################################
use strict;
use vars qw ($q $sbeams $sbeamsImmunostain $PROGRAM_FILE_NAME
...
$sbeamsImmunostain = new SBEAMS::Immunostain;
$sbeamsImmunostain->setSBEAMS($sbeams);
...
sub main { 
    ...
    $sbeamsImmunostain->printPageHeader();
    showMainPage();
    $sbeamsImmunostain->printPageFooter();
...
sub showMainPage {
	...
	<UL>
	<LI> Here is the starter stub for the Immunostain area.
	</UL>
