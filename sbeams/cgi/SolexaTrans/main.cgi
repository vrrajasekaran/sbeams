...
###############################################################################
use strict;
use vars qw ($q $sbeams $sbeamsSolexaTrans $PROGRAM_FILE_NAME
...
$sbeamsSolexaTrans = new SBEAMS::SolexaTrans;
$sbeamsSolexaTrans->setSBEAMS($sbeams);
...
sub main { 
    ...
    $sbeamsSolexaTrans->printPageHeader();
    showMainPage();
    $sbeamsSolexaTrans->printPageFooter();
...
sub showMainPage {
	...
	<UL>
	<LI> Here is the starter stub for the SolexaTrans area.
	</UL>
