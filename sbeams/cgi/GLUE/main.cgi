...
###############################################################################
use strict;
use vars qw ($q $sbeams $sbeamsGLUE $PROGRAM_FILE_NAME
...
$sbeamsGLUE = new SBEAMS::GLUE;
$sbeamsGLUE->setSBEAMS($sbeams);
...
sub main { 
    ...
    $sbeamsGLUE->printPageHeader();
    showMainPage();
    $sbeamsGLUE->printPageFooter();
...
sub showMainPage {
	...
	<UL>
	<LI> Here is the starter stub for the GLUE area.
	</UL>
