...
###############################################################################
use strict;
use vars qw ($q $sbeams $sbeamsTOES $PROGRAM_FILE_NAME
...
$sbeamsTOES = new SBEAMS::TOES;
$sbeamsTOES->setSBEAMS($sbeams);
...
sub main { 
    ...
    $sbeamsTOES->printPageHeader();
    showMainPage();
    $sbeamsTOES->printPageFooter();
