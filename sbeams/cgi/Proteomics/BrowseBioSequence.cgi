...
sub printEntryForm {
    ...
    ($PROGRAM_FILE_NAME) =
      $sbeamsPROT->returnTableInfo($TABLE_NAME,"PROGRAM_FILE_NAME");
	...
	$order_by_clause
      ...
      my $base_url = "$CGI_BASE_DIR/Proteomics/BrowseBioSequence.cgi";
      %url_cols = ('set_tag' => "$CGI_BASE_DIR/Proteomics/ManageTable.cgi?TABLE_NAME=biosequence_set&biosequence_set_id=\%$colnameidx{biosequence_set_id}V",
